string = """nwnwesenenewnwswnwweewswwweswwsew
...
def count_neighbours(x, y):
    n = [(x + a, y + b) for (a, b) in [(-1, 1), (0, 1), (1, 0), (1, -1), (0, -1), (-1, 0)]]
    return sum([c in coords for c in n])


def part2():
    global coords
    if len(coords) == 0:  # in case you didn't run both parts at once
        part1()
